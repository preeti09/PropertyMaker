...
jQuery.validator.addMethod("selectPropertyType", function (value, element) {
    return (value != '');
...
jQuery.validator.addMethod("PlanApprovedBy", function (value, element) {
    return (value != '');
}, "Plan approved by is missing.");
...
jQuery.validator.addMethod("UnitsOfArea", function (value, element) {
    return ($.isNumeric(value) != false);
}, "Unit Of area is missing.");

//Unit detail validation
jQuery.validator.addMethod("title", function (value, element) {
    return (value != '');
}, "Title is missing.");
jQuery.validator.addMethod("bedrooms", function (value, element) {
    return (value != '');
}, "Bedrooms is missing.");
...
jQuery.validator.addMethod("CarParkingArea", function (value, element) {
    return ($.isNumeric(value) != false);
}, "Car Parking Area should be numeric.");
...
jQuery.validator.addMethod("mobileNumber", function (value, element) {
    return this.optional(element) || /[2-9]{2}\d{8}/.test(value);
}, "Please insert valid phone number.");


jQuery.validator.addMethod("BuyOrSell", function (value, element) {
    return (value != '');
}, "Buy or Sell is missing.");
