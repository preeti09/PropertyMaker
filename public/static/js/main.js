    ...
    function get_plot_popupcontent(props, click_latlng) {
        var facing = "";
        let point = [click_latlng.lat, click_latlng.lng];
        ...
        if ((props.plot_spe_1 == "R3") || (props.plot_spe_1 == "C2")) {
          ...
          if (props.plot_dev_a == "CRDA") {
            ...
            <div class='cus-info-button-group text-center'><a href='http://maps.google.com/maps?saddr=my+location&daddr="+point+"' target=_blank><button type='button' class='button transparent mar10'>Take me there</button></a></div>\
            ";
          } else {
            var phase = 1;
            if (props.phase > 1) {
          ...
          var popup_content =
            "\
          <div id='cus-info-header-container'><img src='/img/logos/logo.png'></div>\
          <div id='cus-info-body-container' class='mt15'><b>Landuse Type: </b>" + props.plot_gener + "<br><b>Landuse Details: </b><div class='legendIcon " + props.plot_spe_1 + "'></div></b>" + " " + props.plot_speci + "<div>\
          ";
        }
    ...
    /* function get_plot_popupcontent(props, click_latlng){
        ...
        if ((props.plot_spe_1=="R3") || (props.plot_spe_1=="C2")){
          ...
          if (props.plot_dev_a == "CRDA") {
            ...
            <div class='cus-info-button-group'><a href='http://maps.google.com/maps?saddr=my+location&daddr="+point+"' target=_blank><div id='cus-info-button-lets-talk' class='cus-dir-button' >Take me there</div></a><div id='cus-info-button-lets-talk' class='cus-info-button' onclick='imIntrested("+props.plot_no+");'>I am interested</div></div>\
            ";			  
          }
          else {
            var phase = 1;
   ...
   */
    ...
    function filter_village_list(value){
      ...
      console.log(search_term.length);
