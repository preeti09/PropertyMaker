...
/*     if(obj.ajaxLimit){
        ...
        limit += 'OFFSET '+ obj.ajaxLimit +' LIMIT 10';
    ...
    if(obj.plotSizeMin && obj.type == 'Plots'){
        where +=  '' + and + '  p."Extent" >= ' + obj.plotSizeMin + ' ';
        and =  ' AND';
    }

    if(obj.plotSizeMax  && obj.type == 'Plots'){
...
/*     if (obj.CityID) {
    ...
    if (obj.bedroom) {
        ...
        where += '' + and + ' pud."NumberofBeds" IN(' + obj.bedroom + ' )';
        and = ' AND';
    }
